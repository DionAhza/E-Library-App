        ...
        <div class="w-full max-w-3xl bg-white shadow-xl rounded-2xl p-8">
            <form action="{{  route('book.update', $book->id) }}" method="POST" enctype="multipart/form-data">
              ...
              <div>
                ...
                <input type="text" name="judul" value="{{ $book->judul }}" id="" class="w-full rounded-lg p-3 border border-gray-300 focus:ring-2 focus:ring-blue-500 focus:outline-none">
              </div>
              <div>
                <label for="" class="block mb-2 font-semibold text-gray-700">Sinopsis</label>
                <input type="text" name="sinopsis" value="{{  $book->sinopsis }}" id="" class="w-full rounded-lg p-3 border border-gray-300 focus:ring-2 focus:ring-blue-500 focus:outline-none">
              </div>
              <div>
                <label for="" class="block mb-2 font-semibold text-gray-700">Tahun terbit</label>
                <input type="number" name="tahun_terbit" value="{{  $book->tahun_terbit}}" id="" class="w-full rounded-lg p-3 border border-gray-300 focus:ring-2 focus:ring-blue-500 focus:outline-none">
              </div>
              <div>
