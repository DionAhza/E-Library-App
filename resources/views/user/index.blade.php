...
<body>
  ...
  <img alt=""  src="{{ asset('storage/'. $book->image) }}" class=" w-full h-100 rounded-md object-cover">
  ...
  <div class="mt-2">
    <dl>
      <div>
        ...
        <dd class="text-sm text-gray-500">dirilis pada: {{ $book->tahun_terbit }}</dd>
      </div>
    ...
    <div class="mt-6 flex items-center gap-8 text-xs">
      ...
      <div class="sm:inline-flex sm:shrink-0 sm:items-center sm:gap-2">
        ...
        <div class="mt-1.5 sm:mt-0">
          ...
          <p class="font-medium">{{ $book->genre->name_genre }}</p>
        </div>
      </div>
